...
pub const SUBJECT_FEE_PERCENT: u64 = 50_000_000;

pub const MINT_FEE: u64 = 250_000_000; // Hardcoded mint fee in lamports 0.25 sol
...
pub fn get_price(supply: u64, amount: u64) -> u64 {
    ...
    let summation = sum2
        .checked_sub(sum1)
        .expect("Overflow detected in summation");
    (summation
        .checked_mul(LAMPORTS_PER_SOL as u128)
        .expect("Overflow detected in final multiplication")
        / factor) as u64
}
